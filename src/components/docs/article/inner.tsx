  ...
  return (
    <div className={containerClassName}>
      ...
      {query.data?.thumbnail && (
        <div className="relative flex basis-[30%] items-center justify-center overflow-hidden object-cover [&>div]:w-full">
          <AspectRatio ratio={1}>
