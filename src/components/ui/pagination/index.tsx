...
const activeClassName = "bg-text-primary text-background-full hover:bg-text-primary hover:text-background-full";
const buttonClassName = "leading-[1]";
...
export const Pagination: React.FC<PaginationProps> = ({ index, pages, links, onLink, onPage }) => {
  return (
    <section className="my-4 flex items-center justify-center gap-1 leading-none">
      ...
      {pages >= 1 && (
        <LinkButton
          className={cx(buttonClassName, index === 1 ? activeClassName : "")}
      ...
      {range(index - 1, index + 1)
        ...
        .map(i => (
          <LinkButton
            className={cx(buttonClassName, index === i ? activeClassName : "")}
      ...
      {pages >= 2 && (
        <LinkButton
          className={cx(buttonClassName, index === pages ? activeClassName : "")}
