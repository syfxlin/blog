...
export function HelloWorld() {
  ...
  `;
  // eslint-disable-next-line react-dom/no-dangerously-set-innerhtml -- The script body is a fixed local string.
  return <script id="hello-world-script" dangerouslySetInnerHTML={{ __html: script }} />;
}
