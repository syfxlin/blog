...
// private
export const COLINE_ANALYZE = process.env.COLINE_ANALYZE;
...
export const NEXT_PUBLIC_KEYSTATIC_GITHUB_APP_SLUG = process.env.NEXT_PUBLIC_KEYSTATIC_GITHUB_APP_SLUG;
