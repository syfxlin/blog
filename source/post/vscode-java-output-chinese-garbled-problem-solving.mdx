...
![](https://cdn.jsdelivr.net/gh/syfxlin/pic/2020/03/20200313171055.png)

正常情况下 VSCode 会自动生成一个可用的 launch.json 文件，直接使用此配置可以正常输出中文，但是无法正常输入中文，如下：

![](https://cdn.jsdelivr.net/gh/syfxlin/pic/2020/03/20200313171437.png)
...
![](https://cdn.jsdelivr.net/gh/syfxlin/pic/2020/03/20200313172256.png)

打开该文件后将 `@chcp.com 65001 > NUL` 修改成 `@chcp.com 936 > NUL`

![](https://cdn.jsdelivr.net/gh/syfxlin/pic/2020/03/20200313172428.png)

然后再次运行，你就可以看到输出和输入都正常了

![](https://cdn.jsdelivr.net/gh/syfxlin/pic/2020/03/20200313172509.png)
