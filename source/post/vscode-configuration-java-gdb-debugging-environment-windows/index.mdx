...
![vscode-java-03](./vscode-java-03.png)

按下 `Shift+Ctrl+P`进入命令面板

新版的 VSCode Java 插件已经可以直接创建项目，不再需要使用 Eclipse New Java Project 这个插件来创建项目了。

![vscode-java-04](./vscode-java-04.png)

![vscode-java-05](./vscode-java-05.png)

![vscode-java-06](./vscode-java-06.png)

![vscode-java-07](./vscode-java-07.png)
...
![vscode-java-08](./vscode-java-08.png)
