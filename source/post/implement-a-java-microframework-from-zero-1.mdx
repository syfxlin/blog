...
<repo username="syfxlin" repository="xkjava" />

<message>
  系列文章将以 <code>ce06902e7b8b6650791c41aa0ce13c291b311969</code> 这个 commit
  来进行讲解，如果后续有更改的话我会在文中说明一下。
</message>

## 整体结构

![XK-Java 整体结构图](https://cdn.jsdelivr.net/gh/syfxlin/pic/2021/04/20210408204208.png)
