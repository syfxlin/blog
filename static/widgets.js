Function && Function.prototype && Function.prototype.bind && (/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(),
window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function(t) {
    function e(e) {
            ...
            if (n)
                ...
                u.src = function(t) {
                    return i.p + "js/" + ({
                        ...
                        0: "bd459ee688d39ebbbe0e6b166a1d2cb9",
                        2: "130fa1385f3515f50eef225d271a0454",
                        3: "75a79c54dcfc115f36a5bc654a4d6c25",
                        4: "d5714fadcc438c819f170763a90cd036",
                        5: "436af5b6c6ec891e3b79d7cb7f152eca",
                        6: "4d8f2209bfca17ad1826ab582cf6da09",
                        7: "34340b4862062ad52a16974fec38ada0",
                        8: "aa4b83dd6e9ce610ca8ce9e5fcef2c8f"
                    }[t] + ".js"
                }(t),
                s = function(e) {
    ...
    ,
    i.p = "https://tw.api.syfxlin.win/platform.twitter.com/",
    i.oe = function(t) {
...
, function(t, e, n) {
    ...
    t.exports = {
        ...
        toggle: function(t, e, n) {
            return void 0 === n && t.classList && t.classList.toggle ? t.classList.toggle(e, n) : (n ? s(t, e) : a(t, e),
            n)
        },
        present: u,
        list: c
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n) {
        ...
        function() {
            ...
            r.reject(new Error("Not enough parameters. Expected: " + c))) : l ? (f = u.aug({}, f || {}, e),
...
, function(t, e, n) {
    ...
    t.exports = {
        ...
        read: function(t, e) {
            var n = new i;
            return r.read(s(t, n), e),
            n.promise
        },
        write: function(t, e) {
            var n = new i;
            return r.write(s(t, n), e),
            n.promise
        },
        defer: function(t, e, n) {
            var a = new i;
            return o.isType("function", t) && (n = e,
            e = t,
            t = 1),
            r.defer(t, s(e, a), n),
            a.promise
...
, function(t, e, n) {
    var r = n(9)
      , i = ["https://tw.api.syfxlin.win/syndication.twitter.com", "https://tw.api.syfxlin.win/cdn.syndication.twimg.com", "https://localhost.twitter.com:8444"]
      , o = ["https://tw.api.syfxlin.win/syndication.twitter.com", "https://localhost.twitter.com:8445"]
      , s = ["https://tw.api.syfxlin.win/platform.twitter.com/embed", "https://localhost.twitter.com", /^https:\/\/ton\.smf1\.twitter\.com\/syndication-internal\/embed-iframe\/[0-9A-Za-z_-]+\/app/]
      , a = function(t, e) {
      ...
      , u = function() {
        ...
        return t && a(i, t) ? t : "https://tw.api.syfxlin.win/cdn.syndication.twimg.com"
    }
      , c = function() {
        var t = r.get("settingsSvcHost");
        return t && a(o, t) ? t : "https://tw.api.syfxlin.win/syndication.twitter.com"
    }
      , d = function() {
        var t = r.get("embedIframeURL");
        return t && a(s, t) ? t : "https://tw.api.syfxlin.win/platform.twitter.com/embed"
    };
    function f(t, e) {
        var n = [t];
    ...
    t.exports = {
        cookieConsent: function(t) {
            var e = t || [];
            return e.unshift("cookie/consent"),
            f(c(), e)
        },
        ...
        eventVideo: function(t) {
            var e = t || [];
            return e.unshift("video/event"),
            f(u(), e)
        },
        grid: function(t) {
            var e = t || [];
            return e.unshift("grid/collection"),
            f(u(), e)
        },
        moment: function(t) {
            var e = t || [];
            return e.unshift("moments"),
            f(u(), e)
        },
        settings: function(t) {
            var e = t || [];
            return e.unshift("settings"),
            f(c(), e)
        },
        timeline: function(t) {
            var e = t || [];
            return e.unshift("timeline"),
            f(u(), e)
        },
        tweetBatch: function(t) {
            var e = t || [];
            return e.unshift("tweets.json"),
            f(u(), e)
        },
        video: function(t) {
            var e = t || [];
            return e.unshift("widgets/video"),
            f(u(), e)
        }
    }
}
...
, function(t, e, n) {
    ...
    t.exports = {
        ...
        hasLocalStorageSupport: function() {
            try {
                return s.localStorage.setItem("local_storage_support_test", "true"),
                void 0 !== s.localStorage
            } catch (t) {
                return i.devError("window.localStorage is not supported:", t),
                !1
            }
        }
    }
...
, function(t, e, n) {
    ...
    t.exports = {
        ...
        some: function(t) {
            ...
            return e = (t = t || []).length,
            t = t.filter(s),
            e ? e !== t.length ? r.reject("non-Promise passed to .some") : new r(function(e, n) {
                var r = 0;
                function i() {
                    (r += 1) === t.length && n()
                }
...
, function(t, e, n) {
    var r = n(47)
      ...
      , l = 1
      , h = r.version
      , p = c.get("clientEventEndpoint") || "https://tw.api.syfxlin.win/syndication.twitter.com/i/jot";
    function m(t) {
        return f.aug({
            client: "tfw"
        }, t || {})
    ...
    t.exports = {
        ...
        formatTweetAssociation: function(t, e) {
            var n = {};
            return (e = e || {}).association_namespace = m(t),
            n[l] = e,
            n
        },
        ...
        splitLogEntry: function(t) {
            var e, n, r, i, o;
            return t.item_ids && t.item_ids.length > 1 ? (e = Math.floor(t.item_ids.length / 2),
        ...
        RUFOUS_REDIRECT: "https://tw.api.syfxlin.win/platform.twitter.com/jot.html"
    }
}
, function(t, e, n) {
    var r = n(4)
...
, function(t, e, n) {
    ...
    function o(t) {
        var e, n, o, s = 0;
        for (r = {},
        e = (t = t || i).getElementsByTagName("meta"); e[s]; s++) {
            if (n = e[s],
        ...
        getActiveExperimentDataString: function() {
            return s().then(function(t) {
                var e = Object.keys(t).reduce(function(e, n) {
                    var r;
                    return t[n].version && (r = n.split("_").slice(-1)[0],
                    e.push(r + ";" + t[n].bucket)),
                    e
                }, []);
                return i(e.join(","))
...
, function(t, e, n) {
    ...
    function a(t) {
        ...
        return e || (t.setAttribute("data-twitter-event-id", ++o),
        o)
    }
    function u(t, e, n) {
        var r = 0
...
, function(t, e, n) {
    ...
    t.exports = {
        ...
        rootDocumentLocation: function(t) {
            return t && o.isType("string", t) && (s = t),
            s
        },
        ...
        function t(t) {
            ...
            this.params = Object.keys(this.paramConfigs).reduce(function(n, s) {
                var a = []
                  ...
                  , d = c.validate || i
                  , f = c.transform || o;
                if (s in u && a.push(u[s]),
                s in t && a.push(t[s]),
                a = "fallback"in c ? a.concat(c.fallback) : a,
                n[s] = function(t, e, n) {
                    var i = null;
                    return t.some(function(t) {
                        if (t = r.isType("function", t) ? t() : t,
                        e(t))
                            return i = n(t),
                            !0
                    }),
...
, function(t, e, n) {
    var r, i = n(10), o = n(4), s = n(1), a = n(34), u = n(54), c = n(5), d = n(23), f = "csptest";
    t.exports = {
        inlineStyle: function() {
            ...
            return !!o.body && (c.asBoolean(a.val("widgets:csp")) && (r = !1),
            void 0 !== r ? r : (e.style.display = "none",
            i.add(e, t),
            n.type = "text/css",
...
, function(t) {
    t.exports = {
        version: "e1ffbdb:1614796141937"
    }
}
, function(t, e, n) {
    var r = n(11).publicWarn;
    t.exports = function() {
 ...
 */
    ...
    r = function() {
        ...
        ) : d ? ((p = new MessageChannel).port1.onmessage = h,
        w = function() {
        ...
        function N(e, n, r) {
            ...
            S.error = null) : void 0 === r ? L(e, n) : t(r) ? function(t, e, n) {
                o(function(t) {
                    var r = !1
                      , i = function(t, e, n, r) {
                        try {
        ...
        function C(t, e) {
            var n, r;
            t === e ? I(t, new TypeError("You cannot resolve a promise with itself")) : (r = typeof (n = e),
        ...
        var M = function() {
            function t(t, n) {
                ...
                this._enumerate(n),
                0 === this._remaining && L(this.promise, this._result))) : I(this.promise, new Error("Array Methods must be provided an Array"))
            }
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n, l) {
        var h, p = i.isHorizonTweetEnabled(l, t);
        return o(l, t.tweetId),
        p ? (h = r.createElement("div"),
        new s(u,a,f.TWEET,t,e,n,{
            sandboxWrapperEl: h
...
, function(t) {
    t.exports = {
        tweetButtonHtmlPath: "/widgets/tweet_button.0edc1ef9f8b82d9b79c6115bda79f63f.{{lang}}.html",
        followButtonHtmlPath: "/widgets/follow_button.0edc1ef9f8b82d9b79c6115bda79f63f.{{lang}}.html",
        hubHtmlPath: "/widgets/hub.html",
        widgetIframeHtmlPath: "/widgets/widget_iframe.0edc1ef9f8b82d9b79c6115bda79f63f.html",
        resourceBaseUrl: "https://tw.api.syfxlin.win/platform.twitter.com"
    }
}
, function(t, e, n) {
    var r = n(3)
...
, function(t, e, n) {
    ...
    s.prototype.add = function(t) {
        ...
        this._hasFlushBeenScheduled || (this._hasFlushBeenScheduled = !0,
...
, function(t, e, n) {
    ...
    function s(t, e) {
        var n, r;
        return e = e || i,
        /^https?:\/\//.test(t) ? t : /^\/\//.test(t) ? e.protocol + t : (n = e.host + (e.port.length ? ":" + e.port : ""),
        0 !== t.indexOf("/") && ((r = e.pathname.split("/")).pop(),
        r.push(t),
        t = "/" + r.join("/")),
        [e.protocol, "//", n, t].join(""))
    }
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        var e, n;
        return e = t.headers && t.headers.status,
        !(n = t && !t.error && 200 === e) && t.headers && t.headers.message && r.publicError(t.headers.message),
        {
            success: n,
            resp: t
        }
...
, function(t, e, n) {
    var r, i = n(29), o = 0;
    function s() {
        r && r.length === o && (i.emitter.trigger(i.ALL_WIDGETS_AND_IMAGES_LOADED, r),
        r = null)
    }
...
, , , , , , , , , function(t, e, n) {
    var r, i = n(2), o = n(4), s = n(95), a = n(50), u = n(9), c = n(96), d = n(24), f = n(98), l = n(156), h = n(164), p = n(165), m = n(29), v = n(35);
    n(166),
...
, function(t, e, n) {
    ...
    t.exports = {
        exposeReadyPromise: function(t, e, n) {
            e.ready = r(t.then, t),
            n && Array.isArray(e[n]) && (e[n].forEach(r(t.then, t)),
            delete e[n])
        }
    }
}
, function(t, e, n) {
    ...
    function u(t) {
        ...
        }, t.target)) && a.isIntentURL(e.href) && (n = (n = (n = [u = e.href, "original_referer=" + r.href].join(-1 == u.indexOf("?") ? "?" : "&")).replace(/^http[:]/, "https:")).replace(/^\/\//, "https://"),
        s.open(n, e),
        i.preventDefault(t))
    }
    t.exports = {
...
, function(t, e, n) {
    ...
    d.prototype.open = function(t, e) {
        var n = e && "click" == e.type && o.closest("a", e.target)
          ...
          , d = n && (s.ios() || s.android());
        if (a.isTwitterURL(t))
            return r || d ? this : (this.name = c + u.generate(),
...
, function(t, e, n) {
    ...
    t.exports = {
        ...
        loadPage: function() {
            var t = v();
            return !1 === t ? i.resolve() : (u.set("widgets.loaded", !0),
            w(t))
        },
...
, function(t, e, n) {
    ...
    !function() {
        ...
        o.prototype.read = function(t, e) {
            ...
            "reading" === this.batch.mode || this.batch.scheduled ? r : (this.scheduleBatch(),
            r)
        }
        ,
        o.prototype.write = function(t, e) {
            ...
            "writing" === r || "reading" === r || this.batch.scheduled ? i : (this.scheduleBatch(),
            i)
        }
        ,
        ...
        o.prototype.run = function(t) {
            var e = t.ctx || this
              , n = t.fn;
            if (delete this.batch.hash[t.id],
            !this.onError)
                return n.call(e);
            try {
                n.call(e)
        ...
        o.prototype.schedule = function(t, e) {
            return this.frames[t] ? this.schedule(t + 1, e) : (this.loop(),
            this.frames[t] = e)
        }
        ;
        var s = new o;
...
, function(t, e, n) {
    var r, i, o, s = n(4), a = n(1), u = n(31), c = n(20), d = n(2), f = n(6), l = n(55), h = n(30), p = n(0), m = n(25), v = n(9).get("scribeCallback"), g = Math.floor(1e3 * Math.random()) + "_", w = "rufous-frame-" + g + "-", y = "rufous-form-" + g + "-", b = 0, _ = !1, E = new d;
    function x() {
    ...
    t.exports = {
        clientEvent: function(t, e, n, i) {
            ...
            E.promise.then(function() {
                !function(t, e) {
                    var n, i, s;
                    p.isObject(t) && p.isObject(e) && (l.log(t, e),
    ...
    t.exports = {
        ...
        after: function(t, e) {
            return function() {
                ...
                r.isPromise(n) ? n.then(function(t) {
...
, function(t, e, n) {
    ...
    function R(t, e, n, i, s) {
        ...
        c.src = ["javascript:", 'document.write("");', "try { window.parent.document; }", 'catch (e) { document.domain="' + r.domain + '"; }', "window.parent." + g.fullPath(["sandbox", u]) + "();"].join(""),
    ...
    t.exports = a.couple(n(58), function(t) {
        ...
        t.define("_updateCachedDimensions", function() {
            ...
            return o.read(function() {
                ...
                "visible" == t.sandboxEl.style.visibility ? t._width = n.width : (e = h(t.sandboxEl.parentElement).width,
        ...
        t.override("addRootClass", function(t) {
            var e = this.rootEl;
            return t = Array.isArray(t) ? t : [t],
            this.initialized ? o.write(function() {
                t.forEach(function(t) {
                    i.add(e, t)
                })
        ...
        t.define("addCss", function(t, e) {
            var n;
            return c.inlineStyle() ? ((n = this.createElement("style")).type = "text/css",
            n.appendChild(this.doc.createTextNode(t)),
            o.write(y(e, null, n))) : (l.devError("CSP enabled; cannot embed inline styles"),
            m.resolve())
        }),
...
, function(t, e, n) {
    ...
    function h(t, e, n, r) {
        var i = !a.isObject(t)
          , o = !!e && !a.isObject(e);
        i || o || (u && u(arguments),
        p(s.formatClientEventNamespace(t), s.formatClientEventData(e, n, r), s.CLIENT_EVENT_ENDPOINT))
    }
    function p(t, e, n) {
        var r, u;
        n && a.isObject(t) && a.isObject(e) && (i.log(t, e),
            ...
            t.reduce(function(e, n, r) {
                ...
                function t(e) {
                    ...
                    e.reduce(function(e, n) {
                        ...
                        return l + o < c ? e = e.concat(i) : (r = s.splitLogEntry(n)).length > 1 && (e = e.concat(t(r))),
                        e
                    }, [])
                }(n).forEach(function(t) {
                    var n = g(t);
...
, function(t, e, n) {
    ...
    a.prototype._scheduleFlush = function() {
        this._isPaused || (clearTimeout(this._flushTimeout),
...
, function(t, e, n) {
    var r, i = n(73), o = n(31), s = n(2), a = n(4), u = n(19), c = n(21), d = n(32), f = n(8), l = n(11), h = n(114), p = n(59), m = n(9), v = n(12), g = n(115), w = n(3), y = n(0), b = n(1), _ = p(function() {
        return new s
    });
    function E(t) {
        var e = t || {
    ...
    t.exports = {
        load: function() {
            ...
            // if (c.ie9() || c.ie10() || "http:" !== f.protocol && "https:" !== f.protocol)
                return l.devError("Using default settings due to unsupported browser or protocol."),
                r = E(),
                void _().resolve();
            t = {
                origin: f.origin
            ...
            n = function(t) {
                var n, i, o, s;
                if (i = w.isTwitterURL(t.origin),
                o = e.substr(0, t.origin.length) === t.origin,
                s = w.isTwimgURL(t.origin),
                o && i || s)
                    try {
                        (n = "string" == typeof t.data ? d.parse(t.data) : t.data).namespace === h.settings && (r = E(n.settings),
                        _().resolve())
                    } catch (t) {
                        l.devError(t)
                    }
    ...
    t.exports = c.couple(n(58), function(t) {
        ...
        t.define("_updateCachedDimensions", function() {
            ...
            return a.read(function() {
                ...
                "visible" == t.sandboxEl.style.visibility ? t._width = n.width : (e = l(t.sandboxEl.parentElement).width,
                t._width = Math.min(n.width, e)),
                t._height = n.height
            })
        }),
        ...
        t.override("addRootClass", function(t) {
            ...
            return t = Array.isArray(t) ? t : [t],
            this.initialized ? a.write(function() {
                t.forEach(function(t) {
                    o.add(e, t)
                })
            }) : m.reject(new Error("sandbox not initialized"))
        ...
        t.override("addCss", function(t, e) {
            var n;
            return this.initialized ? f.inlineStyle() ? ((n = this.createElement("style")).type = "text/css",
            n.appendChild(this.targetGlobal.document.createTextNode(t)),
            a.write(h(e, null, n))) : m.resolve() : m.reject(new Error("sandbox not initialized"))
        }),
        t.override("prependCss", function(t) {
            var e = this._shadowRoot;
            return this.addCss(t, function(t) {
...
, function(t, e) {
    ...
    (n = function(t, e) {
        function r(t, e) {
            ...
            var i, o, s = t.resizeSensor.childNodes[0], a = s.childNodes[0], u = t.resizeSensor.childNodes[1], c = (u.childNodes[0],
            function() {
            ...
            var d = function(t, e, n) {
              ...
              , f = function() {
                t.offsetWidth == i && t.offsetHeight == o || t.resizedAttached && t.resizedAttached.call(),
                c()
            };
            d(s, "scroll", f),
            d(u, "scroll", f)
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        ...
        t.define("loadDocument", function(t) {
            var e = new a;
            return this.initialized ? this.iframeEl.src ? u.reject(new Error("widget already loaded")) : (this.iframeEl.addEventListener("load", e.resolve, !1),
            this.iframeEl.addEventListener("error", e.reject, !1),
            this.iframeEl.src = t,
            e.promise) : u.reject(new Error("sandbox not initialized"))
        }),
        t.after("initialize", function() {
            var t = new a
              , e = new a;
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n, c, d) {
        ...
        (new i).attachReceiver(new o.Receiver(r,"twttr.button")).bind("twttr.private.trigger", f).bind("twttr.private.resizeButton", l),
        (new i).attachReceiver(new o.Receiver(r,"twttr.embed")).bind("twttr.private.initialized", function(t) {
            var e = u(this)
              , n = e && e.id
              , r = t.iframe_version;
            n && r && c && c(n, r)
...
, function(t, e, n) {
    ...
    c.prototype._processRequest = function(t, e) {
        ...
        return function(t) {
            var e, n, r;
            return !!o.isObject(t) && (e = t.jsonrpc === u,
            n = o.isType("string", t.method),
            r = !("id"in t) || d(t.id),
            e && n && r)
        }(t) ? (n = "params"in t && (r = t.params,
        !o.isObject(r) || o.isType("function", r)) ? s.resolve(f(t.id, i.INVALID_PARAMS)) : this.registry[t.method] ? this._invoke(t, {
            source: e
        }).then(function(e) {
            return n = t.id,
            {
        ...
        null != t.id ? n : s.resolve()) : s.resolve(f(t.id, i.INVALID_REQUEST))
    }
    ,
    c.prototype.attachReceiver = function(t) {
        return t.attachTo(this),
        this
    }
    ,
    c.prototype.bind = function(t, e) {
        return this.registry[t] = e,
        this
    }
    ,
    c.prototype.receive = function(t, e) {
        ...
        try {
            u = t,
            t = o.isType("string", u) ? r.parse(u) : u
        } catch (t) {
...
, function(t, e, n) {
    ...
    function l(t, e, n) {
        var r;
        t && t.postMessage && (f ? r = (n || "") + o.stringify(e) : n ? (r = {})[n] = e : r = e,
        t.postMessage(r, "*"))
    }
    function h(t) {
    ...
    t.exports = function(t) {
        return a(t, f).map(function(t) {
            return u(function(t) {
                ...
                return a.isPreconfigured && (c.isSearchUrl(a.url) ? d.publicError(l, t) : d.publicLog(h, t)),
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        ...
        t.overrideProperty("id", {
            get: function() {
                var t, e, n;
                return this.params.id ? s + this.params.id : (e = (t = a(this.params)) && t.list_slug.replace(/-/g, "_"),
...
, function(t, e, n) {
    ...
    function p(t) {
        ...
        e.dataSource = u(t),
        d.apply(this, n)) : f.reject("data source must be an object.")
    }
...
, function(t, e, n) {
    var r, i = n(0), o = n(68), s = n(17), a = (r = s(["tweetId"], {}, o),
    function() {
        return i.toRealArray(arguments).slice(1).forEach(function(t) {
            i.isType("object", t) && (t.hideCard = "none" == t.cards || "hidden" == t.cards,
    ...
    function c(t) {
        return function() {
            return r.toRealArray(arguments).slice(1).forEach(function(t) {
                r.isType("object", t) && (t.screenName = t.screenName || t.screen_name,
...
, function(t, e, n) {
    ...
    s.addEventListener && s.addEventListener("DOMContentLoaded", i = function() {
        s.removeEventListener("DOMContentLoaded", i, !1),
        f()
    }
    , !1),
    d.doScroll && s.attachEvent("onreadystatechange", r = function() {
        /^c/.test(s.readyState) && (s.detachEvent("onreadystatechange", r),
        f())
    }
    ),
...
, function(t, e, n) {
    var r = n(168)
      ...
      , s = new r
      , a = function(t) {
        t.widgets && 1 === t.widgets.length && (s.start(),
        i.emitter.unbind(i.ALL_WIDGETS_RENDER_START, a))
    }
      , u = function(t) {
        var e;
        t.widgets && 1 === t.widgets.length && (e = t.widgets[0],
        s.end(),
        e.dataset && e.dataset.tweetId && o({
            duration: s.duration(),
            namespace: {
                element: "tweet",
                action: "render"
...
, function(t, e, n) {
    ...
    function f(t) {
        return t.performance.getEntriesByType("resource").filter(function(t) {
            ...
            return t[e.name] = e.duration,
            t
        }, {})
    }
    r.emitter.bind(r.ALL_WIDGETS_AND_IMAGES_LOADED, function(t) {
        var e, n, r = [];
        c.hasPerformanceInformation() && (e = f(a),
